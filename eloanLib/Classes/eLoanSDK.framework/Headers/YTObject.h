...
//  requestDemo
//
//  Created by liuyutian on 2019/11/19.
...
@interface YTObject : NSObject <YYModel,NSCopying,NSCoding>
/// YYModel - API
...
- (void)mergeValueForKey:(NSString *)key fromModel:(YTObject *)model;
...
- (void)mergeValuesForKeysFromModel:(YTObject *)model;
